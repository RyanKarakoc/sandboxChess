const MoveList = ({ moves }) => {
  ...
  // console.log(pairedMoves);

  return (
    <>
      <div className="flex justify-center items-center mb-20">
        <div className="border-4 border-solid border-black rounded-md p-10 bg-amber-200 w-72">
          <div className="flex justify-center border-4 border-black rounded-md p-2 bg-amber-100 mb-1">
            Moves
          </div>
